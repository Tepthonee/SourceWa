...
if (!(process.env.SESSION || process.env.SESSION_ID)) throw new Error("لم يتم العثور على جلسة ، أضف جلسة قبل بدء الروبوت")
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/0a8d9c568655154249d08.jpg مرحبـًا 🙋 {sender}, أنـا أعمـل \n مـدة التشغيـل: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Tepthon;Skl11;0;https://telegra.ph/file/0a8d9c568655154249d08.jpg;https://chat.whatsapp.com/Dt3C4wrQmt0GG6io1IBIHb',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Tepthon",
    BOT_NAME: process.env.BOT_NAME || 'Tepthon',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝗧𝗘𝗣𝗧𝗛𝗢𝗡 ꫂ; بوت تيبثـون;https://telegra.ph/file/0a8d9c568655154249d08.jpg' : process.env.AUDIO_DATA,
